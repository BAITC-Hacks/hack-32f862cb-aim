...
if path.exists():
    ...
    content = (
        ...
        f"OPTISTOCK_DATABASE_URL=postgresql+psycopg://optistock:{password}@127.0.0.1:5435/optistock\n"
        f"OPTISTOCK_TEST_DATABASE_URL=postgresql+psycopg://optistock:{password}@127.0.0.1:5435/optistock_test\n"
